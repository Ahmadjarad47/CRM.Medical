...
public sealed class SetSubscriptionPackageActiveCommandHandler(
    ISubscriptionPackageRepository repository,
    IDateTimeProvider dateTimeProvider)
    : IRequestHandler<SetSubscriptionPackageActiveCommand, SubscriptionPackageDto>
{
    public async Task<SubscriptionPackageDto> Handle(
        SetSubscriptionPackageActiveCommand request,
