...
public sealed class UpdateUserCommandValidator : AbstractValidator<UpdateUserCommand>
{
    ...
    private static void RequireDateOfBirth(UpdateUserCommand request, ValidationContext<UpdateUserCommand> context)
    {
    ...
    private static void EnsurePatientFieldsAreEmpty(UpdateUserCommand request, ValidationContext<UpdateUserCommand> context)
    {
    ...
    private static void EnsureDoctorFieldsAreEmpty(UpdateUserCommand request, ValidationContext<UpdateUserCommand> context)
    {
    ...
    private static void EnsureLabFieldsAreEmpty(UpdateUserCommand request, ValidationContext<UpdateUserCommand> context)
    {
    ...
    private static void EnsureSpecialFieldsAreEmpty(UpdateUserCommand request, ValidationContext<UpdateUserCommand> context)
    {
    ...
    private static void EnsureEmpty(string? value, string propertyName, ValidationContext<UpdateUserCommand> context)
    {
    ...
    private static void RequireNonEmpty(
        ...
        string propertyName,
        string errorMessage,
        ValidationContext<UpdateUserCommand> context)
    {
        if (string.IsNullOrWhiteSpace(value))
        {
